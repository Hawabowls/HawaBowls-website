<template>
  <div id="container-icon-scroll">
    <svg
      ...
      style="enable-background:new 0 0 768 1366;"
      xml:space="preserve"
    >
      <path
        class="st0 base"
        d="M280.59,1033.09c0.95,0.34,1.9,0.68,2.88,0.96C279.69,1031.5,281.13,1032.94,280.59,1033.09"
      />
      <path
        class="st0 base"
        d="M439.94,1073.92c0.16,0,0.34,0.01,0.52,0.01C442.8,1073.29,441.76,1073.47,439.94,1073.92"
      />
      <path
        class="st0 base"
        d="M280.06,1032.9l0.22,0.16c0.15,0.05,0.25,0.05,0.31,0.02L280.06,1032.9z"
      />
      <path
        class="st1 base"
        d="M251.01,821.3c-11.29-4.11-22.58-8.23-33.88-12.36c-8.87-3.23-20.84-5.55-26.04,2.34
	c-4.25,6.45,0.1,15.78,6.97,19.35c6.87,3.55,15.11,2.85,22.73,1.59c12.69-2.1,25.14-5.56,37.1-10.29"
      />
      <path
        class="st2 bol"
        d="M503.47,851.04c-0.17-1.09-0.86-2.06-1.85-2.57c-0.53-0.27-1.11-0.39-1.69-0.37c-0.87-1.02-2.08-1.83-3.72-2.27
	...
	C314.85,847.6,400.6,839.25,480.95,857.63z"
      ...
      <path
        class="st1 protein"
        d="M212.61,670.45l84.77,192.03l0.2,0.5c0.14,0.32,0.54,0.46,0.89,0.31l0.1-0.04c0.36-0.15,0.54-0.53,0.4-0.85
	...
	"
      ...
      <path
        class="st3 veggie"
        d="M312.7,778.16c0,5.03,5.58,17.38-2.3,17.38c-7.88,0-14.28-7.78-14.28-17.38c0-9.6,6.4-17.38,14.28-17.38
        C318.28,760.78,312.7,773.13,312.7,778.16"
      />
      <path
        class="st3 veggie"
        d="M246.71,777.47c0,8.36-6.78,15.14-15.14,15.14c-8.36,0-15.14-6.78-15.14-15.14c0-8.36,6.78-15.14,15.14-15.14
        C239.94,762.33,246.71,769.11,246.71,777.47"
      />
      <path
        class="st3 toppings"
        d="M255.91,699.61c-0.47-0.73-2.75-4.57-1.18-8.19c0.77-1.77,2.34-3.2,4.42-4.01c2.23-0.87,4.43-1.14,6.21-1.35
      ...
      <path
        class="st1 toppings"
        d="M336.4,759.47c-5.09-3.45-11.46-8.51-14.97-14.15c-6.31-10.14-4.8-23.35-4.78-23.48l-2.23-0.27l-2.23-0.27
	c-0.08,0.6-1.74,14.88,5.43,26.4c7.07,11.37,23.67,20.06,24.37,20.42l0.05-0.1C341,764.69,338.49,762.17,336.4,759.47"
      />
      <path
        class="st1 veggie"
        d="M277.92,714.59c-0.91,0.18-1.85,0.41-2.58,0.98c-0.64,0.5-1.07,1.23-1.39,1.98c-2.1,4.93,1.1,11.36,6.29,12.67
	...
	C296.84,714.5,287.48,712.68,277.92,714.59"
      ...
      <path
        class="st3 veggie"
        d="M517.06,773.44c4.37,2.12,8.86,4.03,13.09,6.4c4.65,2.61,5.37,4.81,4.09,9.77
	...
	c5.54,1.32,10.74,4.06,16.1,6.19C517.24,773.07,517.14,773.26,517.06,773.44"
      ...
      <path
        class="st3 veggie"
        d="M405.89,780.72c-5.18-15.46-2.43-30.23,2.48-44.87c13.91-27.78,33.5-49.18,64.66-57.6
	...
	C412.27,781.37,409.22,781.61,405.89,780.72"
      ...
      <path
        class="st3 veggie"
        d="M358.79,690.88c1.45-4.65,3.44-8.06,5.59-11.38c1.44-2.23,3.41-3.28,6.15-2.97c3.96,0.45,7.8,1.15,11.16,3.52
	...
	c-8.57-13.63-16.81-27.33-19.86-43.6c-3.12-16.56-2.65-32.58,4.31-48.13C357.37,694.59,358.22,692.31,358.79,690.88"
      ...
      <path
        class="st1 veggie"
        d="M389.74,814.52c-4.58-2.53-8.17-6.53-10.01-11.93c-0.47-1.36-0.62-3.07-0.25-4.45
...
export default {
  ...
  methods: {
    ...
    /*   if (e.target.documentElement.scrollTop < 600) {
        ...
        e.target.documentElement.scrollTop <= 1000
      ) {
        this.lvl = 1;
        console.log(
          this.lvl + " nous somme a " + e.target.documentElement.scrollTop
        );
      } else if (e.target.documentElement.scrollTop <= 1500) {
        this.lvl = 2;
        console.log(
          this.lvl + " nous somme a " + e.target.documentElement.scrollTop
        );
        console.log(this.lvl);
      } else if (e.target.documentElement.scrollTop <= 2300) {
        this.lvl = 3;
        console.log(this.lvl);
      } else if (e.target.documentElement.scrollTop <= 2700) {
        this.lvl = 4;
        console.log(this.lvl);
      }
    } */
  ...
  mounted() {
    ...
    window.addEventListener("scroll", function() {
      ...
      console.log("scroll value " + Math.round(scrollpos));
      console.log(vm.lvl);

      if (scrollpos > 400) {
        vm.lvl = 1;
        for (let i = 0; i < base.length; i++) {
          base[i].classList.add("base_active");
        }
      } else {
        for (let i = 0; i < base.length; i++) {
          base[i].classList.remove("base_active");
        }
      }
    });
    if (scrollpos > 500) {
      ...
      for (let i = 0; i < veg.length; i++) {
        veg[i].classList.add("veggie_active");
      }
    } else {
      for (let i = 0; i < veg.length; i++) {
        veg[i].classList.remove("veggie_active");
      }
    }
    if (scrollpos > 600) {
      vm.lvl = 1;
    ...
    if (scrollpos > 600) {
      ...
      for (let i = 0; i < toppings.length; i++) {
        toppings[i].classList.remove("toppings_active");
      }
    }
  }
};
