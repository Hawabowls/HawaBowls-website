...
<template>
  <div class="relative py-16 bg-white">
    ...
    />
    <div
      class="max-w-7xl mx-auto rounded-2xl bg-secondary-500 lg:bg-transparent lg:px-8"
    >
      <div class="lg:grid lg:grid-cols-12">
        ...
        <div
          class="relative bg-secondary-500 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center"
        >
          <div
          ...
          >
            <h2 class="text-3xl font-extrabold text-white" id="join-heading">
              Vous voulez collaborez avec nous ?
            </h2>
            <p class="text-lg text-white">
              Si vous avez des idées de projet ou de partenariat dont vous
              aimeriez nous faire part. N'hésitez pas c'est par ici.
            </p>
            <nuxt-link
