            ...
            <div>
              <div>
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">
                  Cette page permet de voir les detais du produit et de les
                  mettre à jours.
                </p>
              </div>
...
import SelectIngredient from "~/components/admin/SelectIngredient.vue";
export default {
  components: { FooterAdmin, SelectIngredient },
  layout: "admin",
  data() {
    return {
      item: { name: "", price: "" },
